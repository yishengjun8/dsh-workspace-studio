...
export function useSearchState({ workspaceId, settings }) {
  ...
  /* The last submitted query+option combo: the debounce timer must not fire a second request for a combo already submitted via Enter, and toggling options re-runs the search. */
