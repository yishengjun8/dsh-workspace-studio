export const en = {
  ...
  'tab.openInNewWindow': 'Open in new window',
  'tab.openInNewWindow.title': 'Open this file in a new browser tab',
  'tab.close': 'Close Tab',
  ...
  'htmlPreview.preview': 'Preview page',
  'htmlPreview.preview.title': 'View the current file as a rendered HTML page',
  'htmlPreview.edit.title': 'Back to HTML source editing',
  'viewer.menu': 'View as',
  'renderer.image': 'Image preview',
  'renderer.pdf': 'PDF preview',
  'renderer.pdfLoading': 'Loading PDF…',
  'renderer.office': 'Document preview (via PDF)',
  'renderer.officeLoading': 'Converting to PDF locally…',
  'renderer.retry': 'Retry',
  'renderer.officeFailed': 'Document conversion failed.',
  'renderer.officeInvalid': 'This file is not a convertible Office document.',
  'renderer.officeTooLarge': 'The file is too large to convert for preview.',
  'renderer.officeTimeout': 'Conversion timed out; please retry.',
  'renderer.officeBusy': 'The conversion queue is busy; please retry shortly.',
  'renderer.officeChanged': 'The file changed during conversion; please retry.',
  'renderer.officeUnavailable': 'This dsh deployment provides no document conversion service.',
  'renderer.officeMissingFonts': 'Missing fonts: {fonts} (the layout may differ from the original).',
  'renderer.browse': 'Read-only browse',
  'renderer.browse.title': 'Browse the full file content read-only, page by page',
  'renderer.loading': 'Loading…',
  'renderer.loadFailed': 'Failed to load: {message}',
  'renderer.unavailable': 'Rendering is unavailable',
  'renderer.assetFailed': 'Failed to load relative resources; showing the raw page.',
  'renderer.copy': 'Copy',
  ...
  'external.outsideFile': 'File outside the workspace · {name}',
  'external.outsideFile.title': 'File outside the workspace (read-only preview)',
  'plan.tab': 'Plan',
  'plan.loading': 'Loading plan…',
  'plan.failed': 'Could not load plan',
  'plan.expired': 'This temporary plan preview has expired. Reopen it from the pending review card.',
  'review.tabName': 'Change review · turn {turn}',
  'review.loading': 'Loading changes…',
  'review.missing': 'These changes are no longer available: the Session may have ended or the Host restarted.',
  'review.error': 'Could not load the changes',
  'review.retry': 'Retry',
  'review.selectFile': 'Select a changed file',
  'review.binary': 'Binary file',
  'review.oversized': 'File too large; its content was not recorded',
  'review.created': 'Created this turn',
  'review.deletedFile': 'Deleted this turn',
  'review.unchanged': 'No content change',
  'review.coarse': 'File too large; shown as a whole-file replacement',
  'review.truncated': 'Showing the first {count} lines',
  'review.addedCount': '+{count}',
  'review.deletedCount': '-{count}',
  'review.openFile': 'Open in editor',
  'review.openFileAria': 'Open {name} in the editor',
  'review.openFileUnavailable': 'Cannot locate this file (the Session working directory is unknown)',
  ...
  'resize.reviewList': 'Resize the change-review file list',
  ...
  'settings.group.tokens': 'Token Statistics',
  'settings.tokens.usage': 'Token usage',
  'settings.tokens.open': 'Token stats',
  'settings.tokens.hint': 'Aggregate token usage (input, cache read, cache write, output) from every session log over a standard week / calendar month or a custom date range; view totals or a per-model breakdown. Archived sessions are included by default and can be excluded.',
  ...
  'settings.thinkLines': 'Think lines',
  'settings.thinkLines.value': '{n} lines',
  'settings.thinkLines.reset.title': 'Reset to the default line count',
  'settings.editLines': 'Edit lines',
  'settings.editLines.value': '{n} lines',
  'settings.editLines.reset.title': 'Reset to the default line count',
  ...
  'tokens.dialog.title': 'Token Statistics',
  'tokens.range': 'Time range',
  'tokens.range.this-week': 'This week',
  'tokens.range.last-week': 'Last week',
  'tokens.range.this-month': 'This month',
  'tokens.range.last-month': 'Last month',
  'tokens.range.all': 'All',
  'tokens.range.custom': 'Custom',
  'tokens.custom.start': 'Start date',
  'tokens.custom.end': 'End date',
  'tokens.view': 'View',
  'tokens.view.total': 'Totals',
  'tokens.view.model': 'Per model',
  'tokens.archived': 'Include archived sessions',
  'tokens.col.model': 'Model',
  'tokens.col.total': 'Scope',
  'tokens.col.calls': 'Calls',
  'tokens.col.input': 'Input',
  'tokens.col.cacheRead': 'Cache read',
  'tokens.col.cacheWrite': 'Cache write',
  'tokens.col.output': 'Output',
  'tokens.col.sum': 'Total',
  'tokens.totalRow': 'Summary',
  'tokens.loading': 'Computing…',
  'tokens.empty': 'No token usage records in this time range',
  'tokens.empty.filtered': 'No records under the current filters (try checking "Include archived sessions")',
  'tokens.error': 'Token statistics failed',
  'tokens.retry': 'Retry',
  'tokens.invalid.range': 'Pick a valid start and end date (the start date cannot be later than the end date)',
  'tokens.invalid.date': 'Pick both a start and an end date',
  'tokens.viewNote.model': 'Check the boxes on the left; the Summary row below only counts checked models.',
  'tokens.rangeHint': 'Range: {from} ~ {to} ({label})',
  'tokens.range.all.label': 'All records',
  'tokens.failedHint': '{n} session(s) could not be read; the result may be incomplete',
  'tokens.warming': 'Computing in the background: {done} / {total} sessions done; results update automatically',
  'tokens.hint': 'Data comes from the usage records in session logs; records dropped by compaction or truncation are not included. Total = input + cache read + cache write + output.',
  'settings.hint': 'Plugin Update: check and install new versions from GitHub; a dsh restart is required after updating. Token Statistics: aggregate token usage (input, cache read, cache write, output) across sessions by standard week / calendar month or a custom date range, with totals or a per-model view; archived sessions are included by default. Session Browsing: adjust the spin speed of the sidebar mind-map entry icon while the map is streaming (a 0.0x–3.0x speed multiplier, larger is faster; the default 1.2x means one 1 s revolution, and 0 means no rotation). Mind Map Browsing: adjust the hover and selected highlight colors in the mind-map view (amber and the theme blue by default; each can be reset), the session-head and end-card accent colors (violet and green by default; each can be reset), and the mount-edge curve of the mind map (the S-curves from the root to session heads and from branch question cards to branch session heads; default 5.0x, larger bends more visibly, and 0 draws a straight line), plus the optional AI card summary: pick a configured model to summarize the question on each card (the suggested length is adjustable; hover a card to see the full text). File Browsing: adjust the tree row height, how search results are shown, and the file icon badge colors. Content Browsing: pick a highlight preset per file type, adjust the save-conflict dialog comparison text size, choose whether the file browser pane sits on the left or the right of the conversation column, and enable or disable file watching with auto-sync (on by default; switchable to notify-only without auto-reload). Conversation Page Settings: thinking blocks stay visible as cards whose body viewport shows only the latest few lines (adjustable 5–30, default 10), following the newest text while streaming; earlier thinking content is reachable through the card\'s own scrollbar, and clicking the card title row collapses it to a one-line summary; edit/write rows in the conversation always open to show the change (additions highlighted on a green background, deletions struck through in red), and the change viewport follows its own "Edit lines" limit (adjustable 5–30, default 10) with its own scrollbar for the full change. Unchanged items use their defaults.',
  ...
  'readonly.outside-workspace': 'Files outside the workspace are read-only previews',
  ...
  'error.mindmap-doc-size-limit': 'The mind map document exceeds the size limit; archive or delete some cards first',
  'error.disk-full': 'Disk full — the write could not be completed',
  'error.too-many-open-files': 'Too many open files; try again later',
  'error.write-queue-stalled': 'The write queue is busy; try again later',
  'error.request-timeout': 'The request body timed out',
  'error.request-aborted': 'The request was interrupted before it completed',
  ...
  'error.noSessionOpenApi': 'This Harness build exposes no session-opening API, so the session cannot be switched',
  ...
  'error.invalid-range': 'The statistics time range is invalid',
  'error.token-stats-failed': 'Token statistics failed (HTTP {status})',
  'error.invalid-response.token-stats': 'The token statistics API returned an invalid response (HTTP {status})',
  'error.invalid-response.draft': 'The draft API returned an invalid response (HTTP {status})',
  'error.invalid-response.fork-cleanup': 'The fork-cleanup API returned an invalid response (HTTP {status})',
  'error.fork-cleanup-failed': 'Failed to clear the branch\u2019s inherited pending input (HTTP {status})',
  ...
  'mindmap.loadingSlow': 'The first open of a large mind map parses every session log; this may take a moment…',
  ...
  'mindmap.sessionSummary.regenerateAll': 'Regenerate all session summaries',
  'mindmap.sessionSummary.regenerateAll.message': 'Regenerate the summaries of all {n} sessions? The model is called serially, once per session ({n} calls); sessions missing card summaries get the missing ones generated first (existing card summaries are never recalculated). Existing summaries stay until each new one replaces it.',
  'mindmap.sessionSummary.regenerateAll.action': 'Regenerate',
  'mindmap.sessionSummary.regenerateAll.started': 'Regenerating all session summaries ({n} sessions)…',
  'mindmap.sessionSummary.regenerateAll.failed': 'Regenerating session summaries failed: {message}',
  'mindmap.sessionSummary.regenerateAll.empty': 'No sessions to summarize.',
  ...
  'openResource.unsupported': 'This resource needs the native DSH right sidebar, which this layout does not show',
}