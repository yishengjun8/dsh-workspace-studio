export const zh = {
  ...
  'tab.openInNewWindow': '在新窗口内打开',
  'tab.openInNewWindow.title': '在新浏览器标签页中打开此文件',
  'tab.close': '关闭标签',
  ...
  'htmlPreview.preview': '预览页面',
  'htmlPreview.preview.title': '以渲染后的页面预览当前 HTML 文件',
  'htmlPreview.edit.title': '返回 HTML 源码编辑',
  'viewer.menu': '查看方式',
  'renderer.image': '图片预览',
  'renderer.pdf': 'PDF 预览',
  'renderer.pdfLoading': '正在加载 PDF…',
  'renderer.office': '文档预览（转 PDF）',
  'renderer.officeLoading': '正在本地转换为 PDF…',
  'renderer.retry': '重试',
  'renderer.officeFailed': '文档转换失败。',
  'renderer.officeInvalid': '该文件不是可转换的 Office 文档。',
  'renderer.officeTooLarge': '文件过大，无法转换预览。',
  'renderer.officeTimeout': '转换超时，请重试。',
  'renderer.officeBusy': '转换队列繁忙，请稍后重试。',
  'renderer.officeChanged': '文件在转换期间被修改，请重试。',
  'renderer.officeUnavailable': '当前 dsh 未提供文档转换服务。',
  'renderer.officeMissingFonts': '缺少字体：{fonts}（版式可能与原文档不同）。',
  'renderer.browse': '只读浏览',
  'renderer.browse.title': '以只读方式分页浏览完整文件内容',
  'renderer.loading': '正在加载…',
  'renderer.loadFailed': '加载失败：{message}',
  'renderer.unavailable': '渲染功能不可用',
  'renderer.assetFailed': '相对资源加载失败，已显示原始页面。',
  'renderer.copy': '复制',
  'renderer.copied': '已复制',
  'renderer.footnotes': '脚注',
  ...
  'editor.requestTimeout': '请求超时，请重试。',
  'editor.saveTypedDuringMerge': '已保存，但保存期间产生了新的输入，已保留在编辑器中，请再次保存。',
  'editor.saveDraftCleanupFailed': '保存成功，但暂存草稿清理失败（网络问题），刷新后可能恢复旧草稿，请再保存一次。',
  'editor.cancelKeptTyping': '取消时检测到新输入，已保留为未保存修改。',
  'editor.conflictDiskChanged': '磁盘内容在冲突处理期间再次变化，已更新冲突对比，请重新选择。',
  ...
  'status.draftReadFailed': '暂存草稿读取失败，已显示磁盘内容。若此前有未保存修改，请勿直接保存以免覆盖；可稍后刷新重试。',
  ...
  'external.outsideFile': '工作区外文件 · {name}',
  'external.outsideFile.title': '工作区外文件（只读预览）',
  'plan.tab': '计划',
  'plan.loading': '正在读取计划…',
  'plan.failed': '无法读取计划',
  'plan.expired': '临时计划预览已失效，请从仍在等待审批的卡片重新打开。',
  'review.tabName': '变更审查 · 第 {turn} 轮',
  'review.loading': '正在读取变更…',
  'review.missing': '无法读取该轮变更：会话可能已结束，或 Host 已重启。',
  'review.error': '变更读取失败',
  'review.retry': '重试',
  'review.selectFile': '选择变更文件',
  'review.binary': '二进制文件',
  'review.oversized': '文件过大，未记录内容',
  'review.created': '本轮新建的文件',
  'review.deletedFile': '本轮删除的文件',
  'review.unchanged': '内容没有变化',
  'review.coarse': '文件过大，按整行替换显示',
  'review.truncated': '仅显示前 {count} 行',
  'review.addedCount': '+{count}',
  'review.deletedCount': '-{count}',
  'review.openFile': '在编辑器中打开',
  'review.openFileAria': '在编辑器中打开 {name}',
  'review.openFileUnavailable': '无法定位该文件（会话工作目录未知）',
  ...
  'resize.reviewList': '调整变更审查文件列表宽度',
  ...
  'settings.group.update': '插件更新',
  'settings.update.check': '检查更新',
  'settings.update.checking': '正在检查更新…',
  'settings.update.upToDate': '已是最新版本（{current}）',
  'settings.update.available': '发现新版本 {latest}（当前 {current}）',
  'settings.update.download': '下载并更新',
  'settings.update.downloading': '正在下载并安装更新…',
  'settings.update.done': '更新完成，请重启 dsh 并刷新页面后生效',
  'settings.update.done.pending': '检测到已更新的版本 {latest}，请重启 dsh 并刷新页面后生效',
  'settings.update.recheck': '重新检查',
  'settings.update.retry': '重试',
  'settings.update.hint': '从 GitHub（yishengjun8/dsh-workspace-studio）的 main 分支检查并安装新版本。更新会替换插件的安装文件，下载完成后需要重启 dsh 并刷新页面才能生效。',
  'settings.update.fileInstallNote': '当前为本地开发安装：已更新 profile 副本，本地仓库不受影响（此后 npm run bundle 不再自动同步到 profile）。',
  'settings.group.tokens': 'Token 统计',
  'settings.tokens.usage': 'Token 用量',
  'settings.tokens.open': 'Token统计',
  'settings.tokens.hint': '按标准周 / 自然月或自定义时间范围，统计各会话日志中的 token 用量（输入、缓存读取、缓存写入、输出），可查看总计或按模型明细；默认包含已归档会话，取消勾选即排除。',
  ...
  'settings.thinkLines': '思考显示行数',
  'settings.thinkLines.value': '{n} 行',
  'settings.thinkLines.reset.title': '恢复默认行数',
  'settings.editLines': '编辑显示行数',
  'settings.editLines.value': '{n} 行',
  'settings.editLines.reset.title': '恢复默认行数',
  ...
  'tokens.dialog.title': 'Token 统计',
  'tokens.range': '统计范围',
  'tokens.range.this-week': '本周',
  'tokens.range.last-week': '上周',
  'tokens.range.this-month': '本月',
  'tokens.range.last-month': '上月',
  'tokens.range.all': '全部',
  'tokens.range.custom': '自定义',
  'tokens.custom.start': '开始日期',
  'tokens.custom.end': '结束日期',
  'tokens.view': '统计方式',
  'tokens.view.total': '总计',
  'tokens.view.model': '按模型',
  'tokens.archived': '包含已归档会话',
  'tokens.col.model': '模型',
  'tokens.col.total': '统计维度',
  'tokens.col.calls': '调用次数',
  'tokens.col.input': '输入',
  'tokens.col.cacheRead': '缓存读取',
  'tokens.col.cacheWrite': '缓存写入',
  'tokens.col.output': '输出',
  'tokens.col.sum': '合计',
  'tokens.totalRow': '汇总',
  'tokens.loading': '正在统计…',
  'tokens.empty': '该时间段内暂无 token 使用记录',
  'tokens.empty.filtered': '当前条件下暂无 token 使用记录（试试勾选「包含已归档会话」）',
  'tokens.error': 'Token 统计失败',
  'tokens.retry': '重试',
  'tokens.invalid.range': '请选择有效的开始与结束日期（开始日期不能晚于结束日期）',
  'tokens.invalid.date': '请选择开始与结束日期',
  'tokens.viewNote.model': '勾选左侧复选框，底部「汇总」行只统计已勾选的模型。',
  'tokens.rangeHint': '统计范围：{from} ~ {to}（{label}）',
  'tokens.range.all.label': '全部记录',
  'tokens.failedHint': '有 {n} 个会话未能读取，统计结果可能不完整',
  'tokens.warming': '正在后台统计：已完成 {done} / {total} 个会话，结果会自动更新',
  'tokens.hint': '数据来自各会话日志中的 usage 记录；已被压缩或截断的早期记录不计入。合计 = 输入 + 缓存读取 + 缓存写入 + 输出。',
  'settings.hint': '插件更新：从 GitHub 检查并安装新版本，更新后需重启 dsh 生效；Token 统计：按标准周 / 自然月或自定义时间范围汇总各会话的 token 用量（输入、缓存读取、缓存写入、输出），支持总计与按模型明细，默认包含已归档会话；会话浏览设置：调整侧栏导图条目流式输出时旋转图标的速度（倍速 0.0×–3.0×，数值越大越快，默认 1.2× 即 1 秒一圈，0 表示不旋转）；导图浏览设置：调整导图视图中悬浮高亮与选中高亮的颜色（默认分别为琥珀与主题蓝，可分别恢复默认）、会话头卡片与末端卡片的提示色（默认分别为紫与绿，可分别恢复默认），以及导图挂载连线的弯曲幅度（根节点→会话头、分支提问卡→分支会话头的 S 曲线，默认 5.0×，数值越大弯得越明显，0 为直线），并可开启「AI 卡片摘要」：选择已配置的模型自动总结卡片上的提问（可调整建议长度，完整原文可悬浮卡片查看）；文件浏览设置：调整左侧文件树的行高、搜索结果显示方式与图标徽标配色；内容浏览设置：为每种文件类型选择编辑器代码高亮预设、调整保存冲突弹窗中对比文本的字号、选择文件浏览页面显示在对话页面的左侧或右侧，并可开启或关闭「监听文件更改并自动同步」（默认开启，可改为「仅提示，不自动刷新」）；对话页面设置：思考条目以卡片形式常驻显示，正文视口只展示最新数行（5–30 行可调，默认 10 行），输出中自动跟随最新内容，更早的思考内容可通过卡片右侧的滚动条回看，点击卡片标题行可收起为单行摘要；对话中的编辑/写入条目始终默认展开显示改动内容（新增绿底高亮、删除红色删除线），改动内容视口按「编辑显示行数」（5–30 行可调，默认 10 行）限制并提供右侧滚动条，完整改动可滚动查看；未修改的项使用默认值。',
  ...
  'readonly.outside-workspace': '工作区外文件仅支持只读预览',
  ...
  'error.unencodable-char': '文件包含目标编码无法表示的字符，无法保存',
  'error.mindmap-stale-write': '导图根会话已变更，写回已过期，请重新加载导图',
  'error.mindmap-doc-size-limit': '导图文档超过大小上限，请归档或删除部分卡片后再试',
  'error.disk-full': '磁盘空间不足，无法完成写入',
  'error.too-many-open-files': '打开的文件过多，请稍后重试',
  'error.write-queue-stalled': '写入队列阻塞，请稍后重试',
  'error.request-timeout': '请求正文读取超时',
  'error.request-aborted': '请求在完成前被中断',
  ...
  'error.noSessionOpenApi': '当前 Harness 版本没有可用的会话打开接口，无法切换会话',
  ...
  'error.update-failed': '检查更新失败（HTTP {status}）',
  'error.update-check-failed': '检查更新失败',
  'error.update-download-failed': '下载更新失败',
  'error.update-verify-failed': '更新包校验失败',
  'error.update-swap-failed': '更新安装失败',
  'error.update-in-progress': '已有更新任务正在进行',
  'error.update-disabled': '已禁用检查更新',
  'error.update-invalid-request': '更新请求无效',
  'error.update-version-changed': '检查结果已过期，请重新检查后再更新',
  'error.invalid-response.update': '更新接口返回了无效响应（HTTP {status}）',
  'error.invalid-range': '统计时间范围无效',
  'error.token-stats-failed': 'Token 统计失败（HTTP {status}）',
  'error.invalid-response.token-stats': 'Token 统计接口返回了无效响应（HTTP {status}）',
  'error.invalid-response.draft': '暂存盘接口返回了无效响应（HTTP {status}）',
  'error.invalid-response.fork-cleanup': '分支清理接口返回了无效响应（HTTP {status}）',
  'error.fork-cleanup-failed': '分支遗留输入清理失败（HTTP {status}）',
  ...
  'init.error.seams-unavailable': '会话输入接口暂不可用',
  'init.error.session-unavailable': '会话实例不可用',
  ...
  'mindmap.loadingSlow': '首次打开较大的导图需要解析全部会话日志，请稍候…',
  ...
  'mindmap.menu.fold': '折叠',
  'mindmap.menu.foldNow': '立刻折叠',
  'mindmap.menu.createSession': '创建新对话',
  'mindmap.menu.foldAll': '折叠全部可折叠的卡片',
  'mindmap.menu.unfoldAll': '展开全部已经折叠的卡片',
  'mindmap.folded': '已折叠 {n} 张卡片',
  'mindmap.fold.status': '已折叠',
  'mindmap.hint.peek': '点击临时展开',
  'mindmap.fold.done': '已折叠卡片。',
  'mindmap.unfold.done': '已展开。',
  ...
  'mindmap.sessionSummary.fail.sessionGone': '会话已不存在',
  ...
  'mindmap.sessionSummary.regenerateAll': '重新生成所有会话总结',
  'mindmap.sessionSummary.regenerateAll.message': '确定重新生成全部 {n} 个会话的总结吗？将逐个串行调用模型（共 {n} 次）；缺少卡片摘要的会话会先补齐缺失部分（已有卡片摘要不会重算）。旧总结会保留，新总结生成后逐个替换。',
  'mindmap.sessionSummary.regenerateAll.action': '重新生成',
  'mindmap.sessionSummary.regenerateAll.started': '正在重新生成全部会话总结（共 {n} 个会话）…',
  'mindmap.sessionSummary.regenerateAll.failed': '重新生成会话总结失败：{message}',
  'mindmap.sessionSummary.regenerateAll.empty': '没有可总结的会话。',
  ...
  'mindmap.archiveAll.confirmLabel': '请输入 yes 以确认归档',
  'mindmap.archiveAll.confirmHint': '输入 yes 后「归档」按钮才会启用',
  'mindmap.archiveAll.confirmMatched': '✓ 已确认，可执行归档',
  ...
  'openResource.unsupported': '该资源需要 DSH 原生右侧栏，当前布局无法显示',
}