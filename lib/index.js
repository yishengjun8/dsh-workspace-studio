...
async function mindmapParsedTurnsOf(ctx, persistence, sessionId) {
	...
	if (hit !== void 0 && revision !== void 0 && identity !== void 0 && hit.revision === revision && hit.identity === identity) {
	...
	const parsed = parseMindmapTurns(events);
	if (revision !== void 0 && identity !== void 0) mindmapColdParseCacheStore(id, {
		identity,
		revision,
		parsed,
